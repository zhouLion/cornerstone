 ...
 * @memberof rendering
 */
function getRenderCanvas (enabledElement, image, invalidated = false, useAlphaChannel = true) {
 ...
 * @memberof rendering
 */
export function renderGrayscaleImage (enabledElement, invalidated = false) {
 ...
 * @returns {void}
 */
export function addGrayscaleLayer (layer, invalidated = false, useAlphaChannel = false) {
  if (layer === undefined) {
