 ...
 * @memberof rendering
 */
export function renderPseudoColorImage (enabledElement, invalidated = false) {
 ...
 * @returns {void}
 */
export function addPseudoColorLayer (layer, invalidated = false) {
  if (layer === undefined) {
