 ...
 * @memberof rendering
 */
function getRenderCanvas(enabledElement, image, invalidated = false) {
 ...
 * @memberof rendering
 */
export function renderColorImage(enabledElement, invalidated = false) {
...
export function addColorLayer(layer, invalidated = false) {
    if (layer === undefined) {
