 ...
 * @memberof rendering
 */
export function renderLabelMapImage (enabledElement: EnabledElement, invalidated = false) {
 ...
 * @returns {void}
 */
export function addLabelMapLayer (layer: EnabledElementLayer, invalidated = false) {
  if (layer === undefined) {
