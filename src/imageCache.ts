...
const imageCacheDict: Partial<Record<string, Partial<Image>>> = {};

// Array of cachedImage objects
export const cachedImages: Array<Partial<Image>> = [];
 ...
 * @returns {void}
 */
export function setMaximumSizeBytes (numBytes: number | undefined) {
...
function purgeCacheIfNecessary () {
  ...
  function compare (a: Partial<Image>, b: Partial<Image>) {
 ...
 * @returns {void}
 */
export function putImageLoadObject (imageId: string, imageLoadObject: { promise: Promise<any> | undefined; cancelFn: any; }) {
 ...
 * @returns {void}
 */
export function getImageLoadObject (imageId: string) {
  if (imageId === undefined) {
 ...
 * @returns {void}
 */
export function removeImageLoadObject (imageId?: string) {
  if (imageId === undefined) {
 ...
 * @returns {void}
 */
function decache (imageLoadObject: Record<string, any>) {
...
export function changeImageIdCacheSize (imageId: string, newCacheSize: number) {
  ...
  if (cacheEntry) {
    cacheEntry.imageLoadObject.promise.then(function (image: Image) {
