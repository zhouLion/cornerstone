...
const imageLoaders: Record<string, Function | undefined> = {};

let unknownImageLoader: Function | undefined;
 ...
 */
function loadImageFromImageLoader (imageId: string, options: Record<string, any>) {
 ...
 * @memberof ImageLoader
 */
export function loadImage (imageId: string, options: Record<string, any>) {
 ...
 * @memberof ImageLoader
 */
export function loadAndCacheImage (imageId: string, options: Record<string, any>) {
  if (imageId === undefined) {
 ...
 * @memberof ImageLoader
 */
export function registerUnknownImageLoader (imageLoader: Function) {
