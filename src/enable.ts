import { addEnabledElement, EnabledElement } from './enabledElements';
import resize from './resize';
import drawImageSync from './internal/drawImageSync';
import requestAnimationFrame from './internal/requestAnimationFrame';
 ...
 * @memberof Enable
 */
function hasImageOrLayers (enabledElement: EnabledElement) {
 ...
 * @memberof Enable
 */
export default function (element: HTMLElement, options: Record<"renderer" & string, any>) {
  ...
  const enabledElement: EnabledElement = {
    element,
    canvas,
