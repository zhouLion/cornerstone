 ...
 */
export declare function getElementData(element: HTMLElement, dataType: string): any;
/**
 ...
 * @returns {void}
 */
export declare function removeElementData(element: HTMLElement, dataType: string): void;
