 ...
 */
export declare function getEnabledElement(element: HTMLElement): EnabledElement;
/**
 ...
 * @memberof EnabledElements
 */
export declare function addEnabledElement(enabledElement: EnabledElement): void;
/**
 * Adds a Cornerstone Enabled Element object to the central store of enabledElements
 *
 ...
 * @memberof EnabledElements
 */
export declare function getEnabledElementsByImageId(imageId: string): EnabledElement[];
/**
 ...
 * @memberof EnabledElements
 */
export declare function getEnabledElements(): EnabledElement[];
