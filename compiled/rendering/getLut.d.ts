 ...
 * @memberof rendering
 */
export default function _default(image: new (width?: number | undefined, height?: number | undefined) => HTMLImageElement, viewport: any, invalidated: boolean): Uint8ClampedArray;
